  ...
  return (
    <div className="min-h-screen bg-[#080810] flex items-center justify-center relative overflow-hidden py-12 px-4">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-[#c9a84c]/10 blur-[120px]" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[450px] h-[450px] rounded-full bg-[#8b5cf6]/8 blur-[120px]" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            {/* Logo mark */}
            <div
              className="inline-flex items-center justify-center w-16 h-16 rounded-full border border-[#c9a84c]/30 bg-[#c9a84c]/5 mb-4"
            ...
            <div className="mt-5">
              <h2 className="text-white/90 text-lg font-light tracking-wide">Welcome Back</h2>
              <p className="text-white/30 text-xs mt-1">Sign in to your private access</p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between pt-1 text-xs">
              <div className="flex items-center gap-2">
                <button
                  ...
                  style={{
                    border: rememberMe ? '1px solid #c9a84c' : '1px solid rgba(255,255,255,0.2)',
                ...
                <span className="text-white/40 cursor-pointer select-none" onClick={() => setRememberMe(!rememberMe)}>
                  Remember me
                </span>
              </div>
              ...
              <a
                href="#"
                className="text-[#c9a84c]/80 hover:text-[#c9a84c] transition-colors underline-offset-2 hover:underline"
              >
                Forgot Password?
              </a>
            </div>
          ...
          <p className="text-center text-white/25 text-xs mt-6 tracking-wide">
            Not a member yet?{' '}
            <Link to="/register" className="text-[#c9a84c]/70 hover:text-[#c9a84c] font-medium transition-colors duration-200">
              Create Account
            </Link>
          </p>
        </div>
